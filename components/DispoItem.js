...
import { View, Animated, Text, TouchableOpacity, StyleSheet, Picker, Dimensions, Platform, UIManager } from 'react-native';
      ...
      >
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', paddingVertical: 2 }}>
          <View style={{
            ...
            <Picker selectedValue={this.props.day} onValueChange={(day) => this.props.updateDay(day)} style={{ flex: 1, color: '#445870', width: SCREEN_WIDTH * 0.28, textAlign: "left" }}>
          ...
          <View style={{
            ...
            <Picker selectedValue={this.props.from} onValueChange={(from) => this.props.updateHourFrom(from)} style={{ flex: 1, color: '#445870', width: SCREEN_WIDTH * 0.25, textAlign: "center" }}>
          ...
          <View style={{
            ...
            <Picker selectedValue={this.props.to} onValueChange={(to) => this.props.updateHourTo(to)} style={{ flex: 1, color: '#445870', width: SCREEN_WIDTH * 0.25, textAlign: "center", backgroundColor: "" }}>
              <Picker.Item value='8:00' label='8:00' />
              <Picker.Item value='9:00' label='9:00' />
              <Picker.Item value='10:00' label='10:00' />
              <Picker.Item value='11:00' label='11:00' />
