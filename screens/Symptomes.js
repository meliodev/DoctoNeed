...
addPicker = (key) => {
  ...
  <RNPickerSelect
  key= {key} 
  onValueChange={(symp, itemIndex) => { symptomes.push(symp)
...
onConfirmClick() {
 /* Actions.upload({
  ...
  this.props.navigation.navigate('Upload', {doctor: this.doctor, fullDate: this.fullDate, daySelected: this.daySelected, 
