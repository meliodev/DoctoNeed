...
export default class RootComponent extends React.Component {
  ...
  async componentDidMount() {
    ...
    if (!isFirstLaunch) {
      this.props.navigation.navigate('Rooter');
    } else this.setState({hasCheckedAsyncStorage: true});
  }
      ...
      <Swiper main={this}>
        ...
        <View style={[styles.slide, {backgroundColor: '#ffffff'}]}>
          ...
          <View style={[styles.presentation_container, styles.fullScreen]}>
            ...
            <Text style={styles.text}>
              L'application qui met en relation le praticien avec son patient
            </Text>
          </View>
          <View style={[styles.otherComponents_container, styles.fullScreen]}>
            <Image
              source={require('../../assets/footerIconReduced.png')}
        ...
        <View style={[styles.slide, {backgroundColor: '#ffffff'}]}>
          ...
          <View style={[styles.presentation_container, styles.fullScreen]}>
            <Text style={styles.header}>Bienvenue sur{'\n'}DoctoNeed</Text>
            <Text style={styles.text}>
              Prenez rendez-vous dans plusieurs jours ou en urgence
            </Text>
          </View>
          <View style={[styles.otherComponents_container, styles.fullScreen]}>
            <Image
        ...
        <View style={[styles.slide, {backgroundColor: '#ffffff'}]}>
          ...
          <View style={[styles.presentation_container, styles.fullScreen]}>
            <Text style={styles.header}>Bienvenue sur{'\n'}DoctoNeed</Text>
            <Text style={styles.text}>
              Le praticien vous rappelle en visio-consultation
            </Text>
          </View>
          <View style={[styles.otherComponents_container, styles.fullScreen]}>
            <Image
