                    ...
                    <TouchableHighlight
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: SCREEN_WIDTH * 0.12 }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', marginLeft: SCREEN_WIDTH * 0.03 }}>
                                <Text style={{ color: 'black', fontWeight: 'bold' }}>Accueil</Text>
                            </View>
                        </View>
                    </TouchableHighlight>
                    {this.state.isDoctor ?
                    ...
                    <TouchableHighlight
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: SCREEN_WIDTH * 0.12 }}>
                            <Icon name="cog"
                                ...
                                color="#93eafe" />
                            <View style={{ flex: 1, flexDirection: 'row', marginLeft: SCREEN_WIDTH * 0.03 }}>
                                <Text style={{ color: 'black', fontWeight: 'bold' }}>Réglages</Text>
                            </View>
                        </View>
                    </TouchableHighlight>
                    ...
                    <TouchableHighlight
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: SCREEN_WIDTH * 0.12 }}>
                            <Icon name="info-circle"
                                ...
                                color="#93eafe" />
                            <View style={{ flex: 1, flexDirection: 'row', marginLeft: SCREEN_WIDTH * 0.03 }}>
                                <Text style={{ color: 'black', fontWeight: 'bold' }}>Aide</Text>
                            </View>
                        </View>
                    </TouchableHighlight>
